...
export function AutoSliderBanner() {
  ...
  const handleShopClick = () => {
    const productSection = document.getElementById("featured-section")
    if (productSection) {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center">
        ...
        <p className="text-xl text-gray-300 text-center mb-8 max-w-2xl px-4">
          Premium courses, software, and resources for young investors and entrepreneurs
        </p>
        <div className="flex flex-col sm:flex-row gap-4">
          <Button onClick={handleShopClick} size="lg" variant="default">
            Explore Products
          </Button>
          <Link href="/about">
